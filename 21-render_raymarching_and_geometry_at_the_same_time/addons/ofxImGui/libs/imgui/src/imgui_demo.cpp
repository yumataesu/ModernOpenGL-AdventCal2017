...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Window options"))
    {
        ...
        /*
        ImGui::Checkbox("##v", &no_titlebar); ImGui::SameLine(150);
        ImGui::Checkbox("###v", &no_border); ImGui::SameLine(300);
        ImGui::Checkbox("####v", &no_resize);
        ImGui::Checkbox("No move", &no_move); ImGui::SameLine(150);
        ImGui::Checkbox("No scrollbar", &no_scrollbar); ImGui::SameLine(300);
        ImGui::Checkbox("No collapse", &no_collapse);
        ImGui::Checkbox("No menu", &no_menu);
...
//            ImGui::TreePop();
    ...
    if (ImGui::CollapsingHeader("Columns"))
    {
        ...
        {
            ImGui::Text("Without border:");
            ImGui::Columns(4, "mycolumns3", false);  // 3-ways, no border
            ImGui::Separator();
            for (int n = 0; n < 14; n++)
            {
                char label[32];
...
static void ShowExampleAppFixedOverlay(bool* p_open)
{
    ...
    ImGui::SliderFloat("lowpass_cutoff", &lowpass_cutoff, 0.001, 0.5);
